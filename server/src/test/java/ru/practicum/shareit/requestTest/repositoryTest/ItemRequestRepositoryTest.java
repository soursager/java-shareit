package ru.practicum.shareit.requestTest.repositoryTest;
...
public class ItemRequestRepositoryTest {
   ...
   private UserRepository userRepository;
    ...
    void findAllByRequesterId_whenRequesterUserOne_thenReturnListOfUserOneRequest() {
        ...
        assertEquals(requestList.get(0).getRequester().getEmail(), "mail1@mail.ru");
    ...
    void findAllByAllOtherUsers_whenUserIdIsUserOneId_thenReturnListOfUserTwoRequest() {
        ...
        assertEquals(requestList.get(0).getRequester().getEmail(), "mail2@mail.ru");
    }
